/// FIXME: verify that this registration number isn't already taken
#[allow(clippy::redundant_static_lifetimes)]
pub const QUERY: &'static ::prost::ExtensionImpl<Query> = &::prost::ExtensionImpl::<Query> { extendable_type_id: ".google.protobuf.MethodOptions", field_tag: 72295729, proto_int_type: ::prost::ProtoIntType::Default, _phantom: ::core::marker::PhantomData{}};
